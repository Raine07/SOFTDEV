...
class Settings extends Home_Controller {
    ...
    public function getcompany($slug)
    {
        ...
        $data['page'] = 'Settings';
        $data['page_title'] = 'System Settings';
        $data['company'] = $this->admin_model->get_company_slug($slug);
        $data['currencies'] = $this->admin_model->select_asc('country');
        $data['main_content'] = $this->load->view('admin/user/settings', $data, TRUE);
        $this->load->view('admin/index', $data);
    }
    ...
    public function admin_update_company($slug){
        ...
        $data = array(
            ...
            'resilience_rating' => $this->input->post('resilience_rating'),
        ...
        $udata = array(
            'rephotelname' => $this->input->post('name'),
            'uresilience_rating' => $this->input->post('resilience_rating')
        );
        ...
        $this->session->set_flashdata('msg', trans('updated-successfully')); 
        redirect(base_url('admin/settings/getcompany/'.$slug));
    }
