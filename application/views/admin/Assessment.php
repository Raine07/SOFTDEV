<div data-bss-disabled-mobile="true" data-aos="fade-right" data-aos-once="true" style="margin-bottom: 2%;padding-top: 2%;padding-bottom: 2%;background: #ffffff;width: 100%;border-top-style: solid;border-top-color: rgba(116,114,120,0.12);border-bottom-style: none;border-bottom-color: rgba(58,59,69,0.23);">
    ...
    <div class="row">
        <div class="col" style="margin: 9%;">
            ...
            <p style="font-family: 'Open Sans', sans-serif;text-align: justify;">In accordance to the Republic Act No. 10173, known as the Data Privacy Act, is a law that seeks to protect all forms of information, be it private, personal, or sensitive. It is meant to cover both natural and juridical persons involved in the processing of personal information. Therefore, the results and inputs from this assessment form will be kept confident</p>
        </div>
        <div class="col"><img src="/drrh/assets/img/forms-animate.svg" width="70%"></div>
    </div>
    ...
    <div class="container" style="width: 90%;background: #ffffff;padding: 60px;padding-top: 41px;padding-right: 70px;padding-left: 71px;padding-bottom: 118px;margin-bottom: 80px;box-shadow: 0px 0px 5px 1px #bdb1b1;">
        <div>
            <ul class="nav nav-tabs" role="tablist">
                ...
                <li class="nav-item" role="presentation"><a href="<?php echo base_url('index.php/page/assessment/')?>" class="nav-link <?php echo ($this->uri->segment(3) == '' ? 'active' : null); ?>"  id ="tab1nav" style="color: var(--bs-gray-800);">Step 1: Hotel Information</a></li>
                <li class="nav-item" role="presentation"><a href="<?php echo base_url('index.php/page/assessment/step2')?>" class="nav-link <?php echo ($this->uri->segment(3) == 'step2' ? 'active' : null); ?>" id ="tab2nav" style="color: var(--bs-gray-800);font-family: Roboto, sans-serif;">Step 2: Risk Profiling</a></li>
                <li class="nav-item" role="presentation"><a href="<?php echo base_url('index.php/page/assessment/step3')?>"class="nav-link <?php echo ($this->uri->segment(3) == 'step3' ? 'active' : null); ?>" id ="tab3nav" style="color: var(--bs-gray-800);">Step 3: Inventory</a></li>
                <li class="nav-item" role="presentation"><a href="<?php echo base_url('index.php/page/assessment/step4')?>" class="nav-link <?php echo ($this->uri->segment(3) == 'step4' ? 'active' : null); ?>" id ="tab4nav" style="color: var(--bs-gray-800);">Step 4: Final Step - Documents</a></li></ul>
            
            <div class="tab-content">
                <div class="tab-pane  <?php echo ($this->uri->segment(3) == '' ? 'active' : null); ?>" role="tabpanel" id="tab-1">
                    <form action="<?php echo base_url('index.php/assessmentController/assessmentStore'); ?>" method="post">
                        ...
                        <!-- Submit for 1st step -->
                        <button class="btn btn-primary float-end" type="submit" style="background: var(--bs-blue);margin-top: 25px;border-bottom-style: none;">Next Step</button>
                    </form>
                </div>
                <div class="tab-pane  <?php echo ($this->uri->segment(3) == 'step2' ? 'active' : null); ?>" role="tabpanel" id="tab-2">
                    <form action="<?php echo base_url('index.php/assessmentController/step2Store'); ?>" method="post">
                        ...
                        <div class="d-xxl-flex justify-content-xxl-center">
                            <div class="row d-xxl-flex justify-content-xxl-center align-items-xxl-center" style="margin-top: 20px;margin-bottom: 20px;">
                                <div class="col">
                                    <p class="text-start d-xxl-flex" style="margin-bottom: 0px;background: #db5f6b;padding: 8px;border-top-style: solid;border-right-style: solid;border-left-style: solid;"><strong>Almost Certain</strong>: Will undoubtedly happen/recur possibly frequently</p>
                                    <p class="text-start d-xxl-flex" style="margin-bottom: 0px;background: #f4c639;text-align: left;padding: 8px;border-right-style: solid;border-left-style: solid;"><strong>Likely</strong>: Will probably happen/recur but it's not a persisting issue</p>
                                    <p class="text-center d-xxl-flex" style="margin-bottom: 0px;background: #3f88bd;text-align: left;padding: 8px;border-right-style: solid;border-left-style: solid;"><strong>Possible</strong>: Might happen or recur occasionally</p>
                                    <p class="text-center d-xxl-flex" style="margin-bottom: 0px;background: #95ed5f;text-align: left;padding: 8px;border-right-style: solid;border-left-style: solid;"><strong>Unlikely</strong>: Don't expect it to happen/recur but it's possible it may do so</p>
                                    <p class="text-center d-xxl-flex" style="margin-bottom: 0px;background: var(--bs-light);text-align: left;padding: 8px;border-right-style: solid;border-bottom-style: solid;border-left-style: solid;"><strong>Rare</strong>: This will probably never happen/recur</p>
                                </div>
                            </div>
                        </div>
                        <p class="d-xxl-flex justify-content-xxl-center" style="margin-top: -20px;margin-bottom: 19px;"><em>Use this as basis for the&nbsp;</em><strong><em>Likelihood </em></strong><em>&nbsp;of each </em><strong><em>&nbsp;Phenomenon</em></strong><em>.</em></p>
                        <div class="m-auto">
                        ...
                        <div class="m-auto">
                            <h5 style="text-align: center;margin-top: 16px;font-family: Roboto, sans-serif;font-weight: bold;">C. manmadehazards Hazards</h5>
                            <div class="table-responsive">
                                <table class="table table-hover">
                                    <thead>
                                        <tr>
                ...
                <div class="tab-pane <?php echo ($this->uri->segment(3) == 'step4' ? 'active' : null); ?>" role="tabpanel" id="tab-4">
                    ...
                    <div>
                        <?php echo form_open_multipart('index.php/assessmentController/step4Store')?>
