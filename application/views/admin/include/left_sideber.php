    ...
    <div class="sidebar">
      ...
      <nav class="mt-4">
        ...
        <!--
          ...
          <li class="nav-item">
           <a class="nav-link <?php if(isset($page_title) && $page_title == "Services"){echo "active";} ?>" href="<?php echo base_url('admin/services') ?>">
          ...
          <li class="nav-item">
            <a class="nav-link <?php if(isset($page_title) && $page_title == "Users"){echo "active";} ?>" href="<?php echo base_url('admin/users') ?>">
              <i class="nav-icon lni lni-users"></i> <p><?php echo ('Hotels') ?></p>
            </a>
          </li>
        ...
        <!--
         ...
         -->
          ...
          <?php if (is_user()): ?>
            ...
            <li class="nav-item">
              <a class="nav-link <?php if(isset($page_title) && $page_title == "Pages"){echo "active";} ?>" href="<?php echo base_url('admin/pages') ?>">
                <i class="nav-icon lni lni-layout"></i> <p><?php echo ('Resilience Plans') ?></p>
              </a>
            </li>
