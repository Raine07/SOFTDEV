...
<!-- booking embed code -->
<section class="appoinda-embed-container" data-slug="<?php echo $business_slug; ?>" data-url="<?php echo base_url() ?>"></section>
                            ...
                            <div class="mcontainer">
                              <div class="mrow">
                                ...
                                <div class="mcolumn mmiddle">
                                  <span class="mUrlText"><?php echo base_url($slug) ?></span>
                                </div>
