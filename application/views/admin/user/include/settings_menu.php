	...
	<div class="card">
		<div class="card-body">
			<ul class="nav nav-pills flex-column" id="myTab" role="tablist">
				...
				<li class="nav-item">
					<a class="nav-link <?php if(isset($page_title) && $page_title == "System Settings"){echo "active";} ?>" href="<?php echo base_url('admin/settings/company') ?>"><i class="lni lni-home mr-1"></i> <?php echo ('Hotel Settings') ?></a>
				</li>
				<!-- 
				<li class="nav-item">
