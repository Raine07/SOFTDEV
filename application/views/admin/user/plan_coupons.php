                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control" name="name" value="<?php echo html_escape($coupon[0]['name']) ?>" autocomplete="off" required>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control" name="code" value="<?php echo html_escape($coupon[0]['code']) ?>" autocomplete="off" required>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="form-group mb-1">
                                    <input type="number" class="form-control" name="quantity" value="<?php echo html_escape($coupon[0]['quantity']) ?>" autocomplete="off" required>
                                </div>
