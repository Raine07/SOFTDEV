            ...
            <div class="row">
                <div class="col-md-8 m-auto">
                    ...
                    <ul class="nav nav-pills mb-3 mt-5 justify-content-center" id="pills-tab" role="tablist">
                        ...
                        <li class="nav-item mb-2">
                            <a class="linkd nav-link" id="flutterwave-tab" data-toggle="pill" href="#flutterwave" role="tab" aria-controls="flutterwave" aria-selected="false"><?php echo trans('flutterwave') ?> <?php echo trans('flutterwave') ?></a>
                        </li>
                        <?php endif; ?>
