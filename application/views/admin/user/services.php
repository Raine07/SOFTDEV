            ...
            <div class="card add_area <?php if(isset($page_title) && $page_title == "Edit"){echo "d-block";}else{echo "hide";} ?>">
                <div class="card-header with-border">
                  ...
                  <div class="card-tools pull-right">
                    <?php if (isset($page_title) && $page_title == "Edit"): ?>
                      <a href="<?php echo base_url('admin/services') ?>" class="pull-right btn btn-secondary btn-sm"><i class="fa fa-angle-left"></i> <?php echo trans('back') ?></a>
                    <?php else: ?>
                      <a href="#" class="text-right btn btn-secondary cancel_btn btn-sm"><?php echo ('Resilience Plans') ?></a>
                    <?php endif; ?>
                  </div>
                </div>
                ...
                <form method="post" enctype="multipart/form-data" class="validate-form" action="<?php echo base_url('admin/services/add')?>" role="form" novalidate>
                  <div class="card-body">
                    ...
                    <div class="form-group">
                      <label><?php echo trans('resilience-plan-name') ?> <span class="text-danger">*</span></label>
                      <input type="text" class="form-control" required name="name" value="<?php if(isset($service[0]['name'])){echo html_escape($service[0]['name']);} ?>" >
                    </div>

                    <div class="form-group">
                        <label><?php echo trans('resilience-plan-image') ?> <span class="text-danger">*</span></label>
                        <?php if (isset($page_title) && $page_title == "Edit"): ?>
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <div class="input-group">
                              ...
                              <input type="number" class="form-control cus-ra-right duration_input" name="duration" value="<?php if(isset($service[0]['duration'])){echo html_escape($service[0]['duration']);} ?>" required <?php if($service[0]['duration_type'] == 'day'){echo "disabled";} ?>>
              ...
              <div class="card list_area">
                <div class="card-header with-border">
                  <?php if (isset($page_title) && $page_title == "Edit"): ?>
                    ...
                    <?php else: ?>
                      <h3 class="card-title pt-2"><?php echo trans('resilience-plans') ?> </h3>
                    <?php endif; ?>
