        ...
        <div class="row">
            ...
            <div class="col-lg-9 pl-3">
                <div class="card">
                    ...
                    action="
                    <?php if (is_admin()): ?>
                    <?php echo base_url('admin/settings/admin_update_company/'.$company->slug) ?>
                    <?php elseif(is_user()): ?>
                    <?php echo base_url('admin/settings/update_company') ?>
                    <?php endif ?>
                    " role="form" class="form-horizontal pl-20">
                        ...
                        <div class="col-12 mt-4"><p class="font-weight-bold mb-0"><?php echo ('Resilience Rating') ?> </p></div>
                        <div class="card-body p-4 mt-1 m-0">
                            <div class="form-group">
                              <label><?php echo ('Resilience Rating') ?></label>
                                <select name="resilience_rating" class="form-control" >
                                  <option value="None" <?php if($company->resilience_rating=="None"){echo 'selected';}?>>None</option>
                                  <option value="Bronze" <?php if($company->resilience_rating=="Bronze"){echo 'selected';}?>>Bronze</option>
                                  <option value="Silver" <?php if($company->resilience_rating=="Silver"){echo 'selected';}?>>Silver</option>
                                  <option value="Gold" <?php if($company->resilience_rating=="Gold"){echo 'selected';}?>>Gold</option>
                                </select>

                            </div>

                            <div class="form-group">
                            <label class="form-label" for="hotel_str">Hotel Strengths:</label><br>
                                <input type="checkbox" id="str" name="str[]" value="Emergency plan">
                                <label for="str"> Emergency plan</label><br>
                                <input type="checkbox" id="str" name="str[]" value="Emergency preparedness equipment">
                                <label for="str"> Emergency preparedness equipment</label><br>
                                <input type="checkbox" id="str" name="str[]" value="Sustainable initiatives">
                                <label for="str"> Sustainable initiatives</label><br>
                                <input type="checkbox" id="str" name="str[]" value="Emergency response plan">
                                <label for="str"> Emergency response plan</label><br>    
                                <input type="checkbox" id="str" name="str[]" value="Emergency response equipment">
                                <label for="str"> Emergency response equipment</label><br>
                                <input type="checkbox" id="str" name="str[]" value="Worker’s education">
                                <label for="str"> Worker’s education</label><br>
                                <input type="checkbox" id="str" name="str[]" value="Community engagement">
                                <label for="str"> Community engagement</label><br>
                                <input type="checkbox" id="str" name="str[]" value="Budget allocation">
                                <label for="str"> Budget allocation</label><br>
                                <input type="checkbox" id="str" name="str[]" value="Readiness">
                                <label for="str"> Readiness</label><br>
                            </div>
                        </div>
                        <?php endif ?>
