          ...
          <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                  <h3 class="card-title"><?php echo ('Hotels') ?></h3>
                    ...
                    <table class="table table-hover m-0">
                        <thead>
                            <tr>
                                ...
                                <th><?php echo ('Resilience Rating') ?></th>
                                <th><?php echo ('Hotel Representative') ?></th>
                        ...
                        <tbody>
                            ...
                            <?php $i=1; foreach ($users as $user): ?>
                                ...
                                <tr id="row_<?php echo html_escape($user->id) ?>">
                                    ...
                                    <!--HOTEL NAME-->
                                    <td class="pl-2">
                                        <?php if ($user->rephotelname != ''): ?>
                                            <p style="color:#008b46;"><b><?php echo html_escape($user->rephotelname)?></b></p> 
                                        <?php else: ?>
                                            <p style="color:#8b0000;"><i>No Hotel Info</i></p> 
                                        <?php endif ?>
                                    </td>
                                     
                                    <td>
                                    <!--Resilience Rating-->
                                      <?php if ($user->uresilience_rating == 'None'): ?>
                                          <p style="color:#8b0000;"><i>No Rating</i></p>
                                      <?php else: ?>
                                          <p><b><?php echo ($user->uresilience_rating) ?></b></p>
                                      <?php endif ?>
                                    </td>
                                    ...
                                    <td class="pl-2">
                                      <div class="d-flex align-items-center">
                                        ...
                                        <div class="d-flexs flex-columns">
                                            ...
                                            <a target="_blank" class="badge badge-primary-soft" href="<?php echo base_url($user->company_slug) ?>"><i class="fas fa-external-link-alt"></i> <?php echo ('Hotel Page') ?></a>
                                    ...
                                    <td class="actions" width="12%">
                                        <div class="btn-group">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right" role="menu" >
                                                <a href="<?php echo base_url('admin/settings/getcompany/'.html_escape($user->slug));?>" class="dropdown-item"><i class="lnib lni-pencil-alt mr-1"></i>  <?php echo ('Edit') ?></a>
                                                <!--<a data-val="User" data-id="<?php echo html_escape($user->id); ?>" href="<?php echo base_url('admin/users/edit/'.html_escape($user->id));?>" class="dropdown-item delete_item"><i class="lni lni-trash-can mr-1"></i> <?php echo ('Edit') ?></a>-->
                                            <!--
