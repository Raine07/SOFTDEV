            ...
            <div class="row align-items-center justify-content-center">
                <div class="col-md-12 col-lg-6 order-md-1 pr-lg-5 pr-xl-0 mb-8 mb-lg-0">
                    ...
                    <?php if (settings()->trial_days != 0): ?>
                        <a href="<?php echo base_url('/companies') ?>" class="btn btn-primary mt-3 btn-pill fs-14" data-aos="fade-left" data-aos-delay="350"><?php echo trans('start') ?> <?php echo trans('days-trial') ?></a>
                    <?php endif ?>
                </div>
    ...
    <section>
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="mx-auto" style="width:200px; height:200px;"><img class="mx-auto" src="<?php echo base_url() ?>assets/front/img/bronze1.png" alt="..." ></div>                       
                ...
                <div class="col-md-4 mb-7 mb-md-0" data-aos="zoom-in-up" data-aos-delay="250">
                    <div class="text-center">
                <div class="mx-auto" style="width:200px; height:200px;"><img class="mx-auto" src="<?php echo base_url() ?>assets/front/img/silver1.png" alt="..." ></div>       
                ...
                <div class="col-md-4" data-aos="zoom-in-up" data-aos-delay="350">
                    <div class="text-center">
                <div class="mx-auto" style="width:200px; height:200px;"><img class="mx-auto" src="<?php echo base_url() ?>assets/front/img/gold1.png" alt="..." ></div>       
    ...
    <div class="d-xxl-flex justify-content-xxl-center" data-bss-disabled-mobile="true" data-aos="fade-left" data-aos-once="true" style="margin-top: 2%;margin-bottom: 2%;text-align: center;">
        <iframe class="d-xxl-flex justify-content-xxl-center" allowfullscreen="" frameborder="0" src="https://www.youtube.com/embed/UzxphkSy0no" width="560" height="315" style="width: 1000px;height: 500px;">
        </iframe>
    </div>
        ...
        <section>
            <div class="container">
                ...
                <div class="text-center mx-auto mb-8" data-aos="fade-up">
                    <h1 class="h custom-fonts"><?php echo ('Why get your Hotels Rated?') ?></h1>
                        
                <div class="text-center mx-auto mb-8" data-aos="fade-up">
                    <h4 class="h4 custom-fonts"><?php echo trans('the-best-solution-to-start') ?></h4>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6 col-lg-3 mb-5" data-aos="zoom-in-up" data-aos-delay="150">
                        <div class="rtlcard card shadow-hover p-4 p-xl-6 text-center h-100">
                            <div class="rtlcbody card-body p-0">
                                <div class="mb-4"><img width="50px" src="<?php echo base_url('assets/images/assess.svg') ?>"></div>
                                <h3 class="h6"><?php echo trans('booking-website') ?></h3>
                                <p class="mb-0 mb-0"><?php echo trans('booking-website-title') ?>.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6 col-lg-3 mb-5 mb-lg-0" data-aos="zoom-in-up" data-aos-delay="250">
                        <div class="rtlcard card shadow-hover-1 transition-hover p-4 p-xl-6 text-center h-100 bg-secondary-soft">
                            <div class="rtlcbody card-body p-0">
                                <div class="mb-4"><img width="50px" src="<?php echo base_url('assets/images/protect.svg') ?>"></div>
                    ...
                    <div class="col-sm-6 col-lg-3 mb-5 mb-lg-0" data-aos="zoom-in-up" data-aos-delay="350">
                        <div class="rtlcard card shadow-hover-1 transition-hover p-4 p-xl-6 text-center  h-100">
                            <div class="rtlcbody card-body p-0">
                                <div class="mb-4"><img width="50px" src="<?php echo base_url('assets/images/hammer.svg') ?>"></div>
                    ...
                    <div class="col-sm-6 col-lg-3 mb-5 mb-sm-0" data-aos="zoom-in-up" data-aos-delay="450">
                        <div class="rtlcard card shadow-hover-1 transition-hover p-4 p-xl-6 text-center h-100 bg-secondary-soft">
                            <div class="rtlcbody card-body p-0">
                                <div class="mb-4"><img width="55px" src="<?php echo base_url('assets/images/clock.svg') ?>"></div>
  ...
  <div class="text-center mx-auto mb-8" data-aos="fade-up">
    <h1 class="h custom-fonts"><?php echo ('The Rating Process') ?></h1>
    ...
    <section class="get_started bg-white">
        <div class="container">
            ...
            <div class="text-center  pb-5 pt-5">
                ...
                <p class="text-dark" data-aos="fade-up" data-aos-delay="200"><?php echo trans('already-have-an-account') ?></p>
