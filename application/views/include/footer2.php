...
<?php if (isset($page) && $page == 'Company'): ?>
    <div class="<?php echo $is_embed?'d-none':'';?> text-center border-top border-light">
        <div class="container">
            <div class="row py-2">
                <div class="col-md-12">
...
<!-- End Footer -->
    ...
    <input type="hidden" id="base_url" value="<?php echo empty($company_url)?base_url():($company_url.'/'); ?>">
    ...
    <!-- <script src="<?php echo base_url() ?>assets/front/js/intlTelInput-jquery.js"></script> -->
    <script src="<?php echo base_url() ?>assets/front/js/intlTelInput.js"></script>
...
<?php
if( empty($is_embed) || $is_embed==false ){
?>
...
<?php
// here we inject bootstrap modals if they were undefined
if( !empty($bootstrap_modals) ){
  echo $bootstrap_modals;
}
?>
</body>
