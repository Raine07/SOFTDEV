                    ...
                    <nav class="navbar navbar-expand-lg navbar-light bg-whites py-3">
                        ...
                        <div id="navbarContent" class="collapse navbar-collapse mt-2">
                            ...
                            <ul class="navbar-nav align-items-lg-center ml-auto">
                               ...
                               <?php if (is_user()): ?>
                                <li class="nav-item xs-mb-10"><a href="<?php echo base_url('/assessment/step1') ?>" class="nav-link <?php if(isset($page_title) && $page_title == "Assessment"){echo "active";} ?>"><?php echo ('Assessment Form') ?></a></li>
                                <?php endif ?>
                    
                                <?php if (settings()->enable_users == 1): ?>
                                <li class="nav-item xs-mb-10"><a href="<?php echo base_url('companies') ?>" class="nav-link <?php if(isset($page_title) && $page_title == "Companies"){echo "active";} ?>"><?php echo ('Rated Hotels') ?></a></li>
                                <?php endif ?>


                                <?php if (settings()->enable_blog == 1): ?>
                                <li class="nav-item xs-mb-10"><a href="<?php echo base_url('blogs') ?>" class="nav-link <?php if(isset($page_title) && $page_title == "Blogs"){echo "active";} ?>"><?php echo ('News') ?></a></li>
                                <?php endif ?>
                                ...
                                <li class="nav-item xs-mb-10"><a href="<?php echo base_url('contact') ?>" class="nav-link <?php if(isset($page_title) && $page_title == "Contact"){echo "active";} ?>"><?php echo ('Contact Us') ?></a></li>
                    ...
                    <nav class="navbar navbar-expand-lg navbar-light py-3">
                        ...
                        <div id="navbarContent" class="collapse navbar-collapse company mt-2">
                            ...
                            <ul class="navbar-nav align-items-lg-center ml-auto">
                                ...
                                <li class="nav-item"><a href="<?php echo base_url('services/'.$slug) ?>" class="nav-link text-<?php if (isset($page_title) && $page_title == 'Company Home'){echo 'white';} ?> text-xs-white <?php if(isset($page_title) && $page_title == "Services"){echo "active";} ?>"><?php echo ('Resilience Plans') ?></a></li>
                                ...
                                <?php if (!empty(get_pages($company->uid))): ?>
                                    <li class="nav-item dropdown">
                                        <a href="javascript:void(0);" data-toggle="dropdown" class="nav-link dropdown-toggle <?php if (isset($page_title) && $page_title == 'Company Home'){echo 'text-white';} ?>"><?php echo ('Resilience Plans') ?></a>
