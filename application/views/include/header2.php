...
<!--
    ...
    <?php endif ?>
 -->
    <link href="<?php echo base_url() ?>assets/front/css/intlTelInput-new.css" rel="stylesheet">
...
<body<?php if(isset($is_embed)){echo ' class="is-embed-no-bg"';} ?>>
    <!-- main wrapper -->
    <div class="main-wrapper">
            ...
            <header id="navbar">
                <div class="container">
                    <nav class="navbar navbar-expand-lg navbar-light bg-whites py-3">
                        <a class="navbar-brand" href="<?php echo $company_url ?>">
                        ...
                        <div id="navbarContent" class="collapse navbar-collapse mt-2">
                            ...
                            <ul class="navbar-nav align-items-lg-center ml-auto">
                                ...
                                <li class="nav-item xs-mb-10"><a href="<?php echo $company_url ?>" class="nav-link  <?php if(isset($page_title) && $page_title == "Home"){echo "active";} ?>"><?php echo trans('home') ?></a></li>

                                <li class="nav-item xs-mb-10"><a href="<?php echo $company_url.'/pricing' ?>" class="nav-link <?php if(isset($page_title) && $page_title == "Pricing"){echo "active";} ?>"><?php echo trans('pricing') ?></a></li>
                                
                                <li class="nav-item xs-mb-10"><a href="<?php echo base_url('/Assessment') ?>" class="nav-link <?php if(isset($page_title) && $page_title == "Assessment"){echo "active";} ?>"><?php echo trans('Assessment') ?></a></li>

                                <?php if (settings()->enable_users == 1): ?>
                                <li class="nav-item xs-mb-10"><a href="<?php echo $company_url.'/users' ?>" class="nav-link <?php if(isset($page_title) && $page_title == "Companies"){echo "active";} ?>"><?php echo trans('companies') ?></a></li>
                                <?php endif ?>


                                <?php if (settings()->enable_blog == 1): ?>
                                <li class="nav-item xs-mb-10"><a href="<?php echo $company_url.'/blogs' ?>" class="nav-link <?php if(isset($page_title) && $page_title == "Blogs"){echo "active";} ?>"><?php echo trans('blogs') ?></a></li>
                                <?php endif ?>


                                <?php if (settings()->enable_faq == 1): ?>
                                <li class="nav-item xs-mb-10"><a href="<?php echo $company_url.'/faqs' ?>" class="nav-link <?php if(isset($page_title) && $page_title == "Faqs"){echo "active";} ?>"><?php echo trans('faqs') ?></a></li>
                                <?php endif ?>

                                <li class="nav-item xs-mb-10"><a href="<?php echo $company_url.'/contact' ?>" class="nav-link <?php if(isset($page_title) && $page_title == "Contact"){echo "active";} ?>"><?php echo trans('contact') ?></a></li>
                                    ...
                                    <li class="nav-item dropdown">
                                        ...
                                        <ul class="dropdown-menu shadow">
                                            <?php foreach (get_pages() as $page): ?>
                                                <li><a class="dropdown-item" href="<?php echo $company_url.'/page/'.$page->slug ?>"><?php echo html_escape($page->title) ?></a></li>
                                            <?php endforeach ?>
                                        </ul>
                                    </li>
                                <?php endif ?>
                            ...
                            <ul class="navbar-nav align-items-lg-center ml-lg-auto mt-0">
                                <li class="nav-item mr-0">
                                    ...
                                    <?php elseif(is_user()): ?>
                                        ...
                                        <a class="btn btn-sm btn-light-secondary ml-auto" href="<?php echo $company_url.'/auth/logout' ?>"><i class="lni lni-exit"></i> <?php echo trans('logout') ?> </a>

                                         <a class="btn btn-sm btn-primary ml-auto" href="<?php echo $company_url.'/admin/dashboard/user' ?>"><i class="icon-speedometer"></i> <?php echo trans('dashboard') ?></a>

                                    <?php else: ?>
                                        <a class="btn btn-sm btn-light ml-auto" href="<?php echo $company_url.'/login' ?>"><?php echo trans('sign-in') ?></a>
                                        <a class="btn btn-sm btn-primary ml-auto" href="<?php echo $company_url.'/register' ?>"><?php echo trans('get-started') ?></a>
                                    <?php endif ?>
                                </li>
                            </ul>
        ...
        <?php if (isset($page) && $page == 'Company'): ?>
            <header class="<?php echo $is_embed?'d-none':'';?> <?php if (isset($page_title) && $page_title == 'Company Home'){echo 'position-absolute';} ?>  left-0 top-0 w-100">
                <div class="container">
                    <nav class="navbar navbar-expand-lg navbar-light py-3">
                        ...
                        <div id="navbarContent" class="collapse navbar-collapse company mt-2">
                            ...
                            <ul class="navbar-nav align-items-lg-center ml-auto">
                                <li class="nav-item"><a href="<?php echo $company_url ?>" class="nav-link text-<?php if (isset($page_title) && $page_title == 'Company Home'){echo 'white';} ?> text-xs-white <?php if(isset($page_title) && $page_title == "Home"){echo "active";} ?>"><?php echo trans('home') ?></a></li>

                                <li class="nav-item"><a href="<?php echo $company_url.'/services' ?>" class="nav-link text-<?php if (isset($page_title) && $page_title == 'Company Home'){echo 'white';} ?> text-xs-white <?php if(isset($page_title) && $page_title == "Services"){echo "active";} ?>"><?php echo trans('services') ?></a></li>

                                <?php if (check_user_feature_access($company->user_id, 'gallery') == TRUE): ?>
                                    <?php if ($company->enable_gallery == TRUE): ?>
                                        <li class="nav-item"><a href="<?php echo $company_url.'/gallery' ?>" class="nav-link text-<?php if (isset($page_title) && $page_title == 'Company Home'){echo 'white';} ?> text-xs-white <?php if(isset($page_title) && $page_title == "Gallery"){echo "active";} ?>"><?php echo trans('gallery') ?></a></li>
                                    <?php endif; ?>
                                <?php endif; ?>
                            </ul>
                            ...
                            <ul class="navbar-nav align-items-lg-center ml-lg-auto">
                                <li class="nav-item mr-0">
                                    <?php if(is_user()): ?>
                                        <a class="btn btn-sm btn-light-secondary ml-auto text-<?php if (isset($page_title) && $page_title == 'Company Home'){echo 'white';} ?> text-xs-white" href="<?php echo $company_url.'/auth/logout' ?>"><i class="icon-logout"></i> <?php echo trans('logout') ?> </a>
                                    ...
                                    <?php elseif(is_customer()): ?>
                                        ...
                                        <a class="btn btn-sm btn-light-secondary ml-auto" href="<?php echo $company_url.'/auth/logout' ?>"><i class="lni lni-exit"></i> <?php echo trans('logout') ?> </a>
                                         ...
                                         <a class="btn btn-sm btn-primary ml-auto" href="<?php echo $company_url.'/customer/appointments' ?>"><i class="icon-speedometer"></i> <?php echo trans('dashboard') ?></a>
                                    <?php elseif(is_staff()): ?>

                                        <a class="btn btn-sm btn-light-secondary ml-auto" href="<?php echo $company_url.'/auth/logout' ?>"><i class="lni lni-exit"></i> <?php echo trans('logout') ?> </a>

                                         <a class="btn btn-sm btn-primary ml-auto" href="<?php echo $company_url.'/staff/appointments' ?>"><i class="icon-speedometer"></i> <?php echo trans('dashboard') ?></a>
                                     <?php elseif(!empty($slug)): ?>
                                         <a id="customerLoginLink" class="btn btn-sm btn-light-secondary ml-auto text-<?php if (isset($page_title) && $page_title == 'Company Home'){echo 'white';} ?> text-xs-white" href="#<?php echo $slug.'/login' ?>"><?php echo trans('sign-in') ?></a>
                                         <a id="customerRegisterLink" class="btn btn-sm btn-primary ml-auto" href="#<?php echo $slug.'/register' ?>"><?php echo trans('get-started') ?></a>
                                     <?php else: ?>
                                         <a class="btn btn-sm btn-light-secondary ml-auto text-<?php if (isset($page_title) && $page_title == 'Company Home'){echo 'white';} ?> text-xs-white" href="<?php echo $company_url.'/login' ?>"><?php echo trans('sign-in') ?></a>
                                         <a class="btn btn-sm btn-primary ml-auto" href="<?php echo $company_url.'/register' ?>"><?php echo trans('get-started') ?></a>
                                     <?php endif ?>
                                </li>
                            </ul>
