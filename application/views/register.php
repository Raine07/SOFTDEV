    ...
    <div class="container <?php if(settings()->site_info == 3){echo "d-hide";} ?>">
        <div class="row justify-content-center justify-content-lg-starts">
            <div class="col-md-8 col-lg-7 col-xl-7 offset-lg-1 offset-xl-2 my-1" data-aos="fade-left"
                ...
                <?php else: ?>
                <div class="mb-6 text-center">
                    <h3 class="mb-0 custom-font"><?php echo ('Let\'s Register your Hotel') ?></h3>
                    <p class="mb-0"><?php echo ('Let\'s start with information about yourself') ?></p>
                </div>
                ...
                <form id="register_form" class="authorization__form authorization__form--shadow leave_con" method="post"
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            ...
                            <div class="form-group mb-2">
                                <label class="mb-1"><?php echo ('Full Name') ?> <span class="text-danger">*</span></label>
                                <div class="input-group input-group-sm">
                                    <?php $parse = parse_url(base_url()) ?>
                                    <input type="text" id="name" name="name" placeholder="<?php echo('Your Full Name') ?>"class="form-control form-control-sm" autocomplete="off">
                                </div>
                            </div>
                            ...
                            <div class="custom-control custom-checkbox">
                                ...
                                <label class="custom-control-label" for="terms-condition">
                                    <?php echo trans('i-have-read-and-understood-the') ?> <a
                                        href="<?php echo base_url('page/terms-of-service') ?>" rel="noopener noreferrer" target="_blank"><?php echo trans('terms-and-conditions') ?> </a>
                                    <?php echo trans('and') ?> <a href="<?php echo base_url('page/privacy-policy') ?>" rel="noopener noreferrer" target="_blank"> <?php echo trans('privacy-policy') ?> </a><?php echo trans('of-this-site') ?>.</label>
                            </div>
                        </div>
        ...
        <div class="w-lg-85 p-5 text-center">
            ...
            <div class="browser">
                ...
                <div class="browser-container">
                    ...
                    <h5>Description:</h1>
                    <p class="servicet">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>

                    <div class="brow_service">
                        <div class="row">
                            <div class="col-md-4 text-left">
                                <p class="servicet"><?php echo ('Resilience Plan 1') ?></p>
                            ...
                            <div class="col-md-4 text-left">
                                <p class="servicet"><?php echo ('Resilience Plan 2') ?></p>
                                <article class="skeleton">
                                    <div class="image"></div>
                                    <p class="line"></p>
                                    <p class="line2"></p>
                            ...
                            <div class="col-md-4 text-left">
                                <p class="servicet"><?php echo ('Resilience Plan 3') ?></p>
                                <article class="skeleton">
                                    <div class="image"></div>
                                    <p class="line"></p>
                                    <p class="line2"></p>
