    ...
    <div class="container pt-12 ">
        <div class="row align-items-center justify-content-center text-center min-height-lg-35vh">
            <div class="col-md-10 col-lg-7">
                ...
                <?php if($company->resilience_rating=="Bronze")
                                    {echo '<div class="mx-auto" style="width:100px; height:100px;"><img class="mx-auto" src="https://ddrh.homes/assets/front/img/bronze1.png" alt="bronze" title="This hotel has finished the resilience rating process and was evaluated to have a Bronze level Resileince."></div>';}?>
                                      <?php if($company->resilience_rating=="Silver")
                                    {echo '<div class="mx-auto" style="width:100px; height:100px;"><img class="mx-auto" src="https://ddrh.homes/assets/front/img/silver1.png" alt="silver" title="This hotel has finished the resilience rating process and was evaluated to have a Silver level Resileince."></div>';}?>
                                    <?php if($company->resilience_rating=="Gold")
                                    {echo '<div class="mx-auto" style="width:100px; height:100px;"><img class="mx-auto" src="https://ddrh.homes/assets/front/img/gold1.png" alt="Gold" title="This hotel has finished the resilience rating process and was evaluated to have a Golden level of Resileince."></div>';}?>
                <!--
