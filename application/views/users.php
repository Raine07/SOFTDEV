                ...
                <div class="col-md-3">
                    <div class="form-group">
                        <select name="category" class="form-controls sort_front select2" style="width: 100%">
                            <option value=""><?php echo ('All Ratings') ?></option>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        <select name="country" class="form-controls sort_front select2" style="width: 100%">
                            <option value=""><?php echo ('All Cities') ?></option>
                            <?php foreach ($cities as $city): ?>
                                <option <?php if(isset($_GET['city']) && $_GET['city'] == $city->id){echo "selected";} ?> value="<?php echo html_escape($city->id); ?>"><?php echo html_escape($city->city_name); ?></option>
                            <?php endforeach ?>
                        </select>
                    </div>
                </div>
        ...
        <?php else: ?>
            <div class="row mt-4">
                <?php $c=1; foreach ($companies as $company): ?>
                    <?php if ($company->resilience_rating != 'None'): ?>
                        <div class="col-sm-6 col-md-4 mb-5 mb-md-0">
                            <div class="card profile-card-2 mb-4" data-aos="fade-up" data-aos-delay="<?= $c * 50; ?>">
                                ...
                                <div class="card-body pt-5">
                                    ...
                                    {echo '<div class="mx-auto" style="width:100px; height:100px;"><img class="mx-auto" src="https://ddrh.homes/assets/front/img/bronze1.png" alt="..." ></div>';}?>
                                      <?php if($company->resilience_rating=="Silver")
                                    {echo '<div class="mx-auto" style="width:100px; height:100px;"><img class="mx-auto" src="https://ddrh.homes/assets/front/img/silver1.png" alt="..." ></div>';}?>
                                    <?php if($company->resilience_rating=="Gold")
                                    {echo '<div class="mx-auto" style="width:100px; height:100px;"><img class="mx-auto" src="https://ddrh.homes/assets/front/img/gold1.png" alt="..." ></div>';}?>
